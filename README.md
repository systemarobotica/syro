...
Published under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | ISBN 979-8-89460-024-3 | Staten House
...
## Contributing to the Robot Archive

Know a robot that should be classified? Two ways to contribute:

1. **Submit via the website** — Use the form at `/archive`
2. **Fork & PR** — Add entries to `src/data/taxonomy.json` and submit a pull request
